...
class VLMtoBBox:
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                "api": ("SAMHERA_API",),
                "model_name_override": ("STRING", {"default": "", "placeholder": "Override model (leave empty to use dropdown)"}),
...
class VLMtoPoints:
    ...
    def run(self, image, api_key, provider, model_name,
            ...
            bbox_context=None, few_shot_examples="", api=None, model_name_override=""):
